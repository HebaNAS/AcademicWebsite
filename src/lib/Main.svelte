    ...
    <div class="absolute mt-8 mx-auto xl:max-w-4xl w-10/12 lg:w-6/12 xl:w-1/2 h-max xl:inset-y-0 xl:my-auto flex flex-wrap lg:flex-nowrap inset-x-0">
        <div class="flex grow flex-col w-full lg:w-5/6 xl:w-max h-fit xl:h-min xl:max-w-sm items-stretch xl:self-center bg-theme-fg-light dark:bg-theme-action grad-2 rounded shadow-lg xl:drop-shadow-lg">
            <div class="h-fit">
                ...
                <div class="text-center my-10 lg:my-4 xl:my-10 w-10/12 lg:w-8/12 xl:w-10/12 mx-auto">
                    ...
                    <p class="text-theme-text-dark dark:text-theme-fg-dark">Adjunct Lecturer | PhD Candidate</p>
            ...
            <div class="flex flex-row justify-around w-full mt-10 lg:mt-5 xl:mt-10 bg-white py-6 lg:py-3 xl:py-6">
                ...
                <div>
                    <a href="https://github.com/HebaNAS">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-theme-action hover:scale-150 hover:text-theme-action-dark transform transition-all ease-in-out duration-500" viewBox="0 0 496 512" fill="currentColor">
                            <!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                ...
                <div>
                    <a href="https://www.linkedin.com/in/hebaelshimy/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3B0PJshc82TSmaAIbA6M0L9A%3D%3D">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-theme-action hover:scale-150 hover:text-theme-action-dark transform transition-all ease-in-out duration-500" viewBox="0 0 448 512" fill="currentColor">
                            <!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                ...
                <div>
                    <a href="mailto:he12@hw.ac.uk">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-theme-action hover:scale-150 hover:text-theme-action-dark transform transition-all ease-in-out duration-500" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="lg:self-center lg:pl-10 pt-10 px-4 lg:pt-0">
            ...
            <p class="text-theme-text-dark dark:text-theme-fg-light">
                I'm an adjunct lecturer and PhD candidate at Heriot-Watt University, Dubai Campus. I'm a Data Scientist by education and specialise in Deep Learning and Computer Vision.
            </p>
            <p class="text-theme-text-dark dark:text-theme-fg-light">
