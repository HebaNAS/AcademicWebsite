...
<section class="w-screen flex items-stretch flex-col relative main-section pb-20 mb-20 lg:mb-0">
    <!-- Background gradient div -->
    <div class="absolute top-0 left-0 right-0 bottom-0 bg-theme-fg-dark dark:bg-theme-action-dark grad-1"></div>
    
    <!-- Original content -->
    <div class="absolute mt-8 mx-auto xl:max-w-4xl w-10/12 lg:w-6/12 xl:w-1/2 h-max xl:inset-y-0 xl:my-auto flex flex-wrap lg:flex-nowrap inset-x-0 z-10">
        <div class="flex grow flex-col w-full lg:w-5/6 xl:w-max h-fit xl:h-min xl:max-w-sm items-stretch xl:self-center bg-theme-fg-light dark:bg-theme-action grad-2 rounded shadow-lg xl:drop-shadow-lg">
            ...
            <div class="flex flex-row justify-around w-full mt-10 lg:mt-5 xl:mt-10 bg-white py-6 lg:py-3 xl:py-6 rounded">
                ...
                <div>
                    <a href="https://www.linkedin.com/in/hebaelshimy/">
                ...
                <div>
                    <a href="mailto:H.Elshimy@hw.ac.uk">
...
@media (min-width: 1024px) and (max-width:1279px) {
    .main-section {
        min-height: calc(800px - 14rem);
    }
}

@media (max-width:1023px) {
    .main-section {
        min-height: calc(1500px - 7rem);
    }
}
...
.grad-2 {
    background: linear-gradient(165deg, rgba(253, 252, 251, 0.85) 0%, rgba(226, 209, 195, 0.4) 100%);
}
